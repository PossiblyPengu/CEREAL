          ...
          {activeSection === 'appearance' && <div className="settings-section">
            ...
            <div className="settings-group">
              ...
              <div className="settings-row">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <input
                    ...
                    value={local.accentColor || (THEMES[local.theme || 'midnight']?.accent ?? '#d4a853')}
                    onChange={e => {
              ...
              <div className="settings-row" style={{ borderBottom: 'none' }}>
                ...
                <SettingsToggle value={local.showAnimations !== false} onChange={v => update('showAnimations', v)} />
              </div>
            </div>
          </div>}
          ...
          {activeSection === 'behavior' && <div className="settings-section">
            ...
            <div className="settings-group">
              <div className="settings-row">
                ...
                <SettingsToggle value={!!local.autoSyncPlaytime} onChange={v => update('autoSyncPlaytime', v)} />
              </div>
              <div className="settings-row">
                ...
                <SettingsToggle value={!!local.minimizeOnLaunch} onChange={v => update('minimizeOnLaunch', v)} />
              </div>
              <div className="settings-row" style={{ borderBottom: 'none' }}>
                ...
                <SettingsToggle value={!!local.discordPresence} onChange={v => update('discordPresence', v)} />
              </div>
            </div>
          </div>}
          ...
          {activeSection === 'system' && <div className="settings-section">
            ...
            <div className="settings-group">
              <div className="settings-row">
                ...
                <SettingsToggle value={!!local.launchOnStartup} onChange={v => update('launchOnStartup', v)} />
              </div>
              <div className="settings-row" style={{ borderBottom: 'none' }}>
                ...
                <SettingsToggle value={!!local.closeToTray} onChange={v => update('closeToTray', v)} />
              </div>
            </div>
