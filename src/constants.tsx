...
// Note on text tokens:
//   text  — primary content (~14:1 contrast)
//   text2 — secondary content / muted labels (~7:1 contrast, WCAG AAA)
//   text3 — tertiary / descriptions (~4.8:1 contrast, WCAG AA body text)
//   text4 — quaternary / hints, eyebrows, inactive labels (~3:1 contrast, WCAG AA UI)
// Bumped from previous values which fell well below WCAG minimums (1.4–3:1 for text4).
//
// Note on preview swatches:
//   Order is [void, cardUp, accent, text] — a dark→light palette ramp.
//   Previously [void, accent, surface, text] caused the void+surface darks to
//   visually merge into one big blob since they only differ by ~4% lightness.

export const THEMES: Record<string, Theme> = {
  midnight:  { label: 'Midnight',      accent: '#d4a853', void: '#07070d', surface: '#0d0d16', card: '#101018', cardUp: '#16161f', text: '#f3efe8', text2: '#c4beb1', text3: '#9e978a', text4: '#76706a', glass: 'rgba(255,255,255,0.04)', glassBorder: 'rgba(255,255,255,0.09)', glow: 'rgba(255,255,255,0.08)', bodyBg: '#07070d', preview: ['#07070d','#16161f','#d4a853','#f3efe8'] },
  obsidian:  { label: 'Obsidian',      accent: '#8b5cf6', void: '#09090b', surface: '#0f0f14', card: '#13131a', cardUp: '#1a1a22', text: '#eeebf5', text2: '#bcb7ce', text3: '#9893ab', text4: '#706c81', glass: 'rgba(139,92,246,0.05)', glassBorder: 'rgba(139,92,246,0.12)', glow: 'rgba(139,92,246,0.1)', bodyBg: '#09090b', preview: ['#09090b','#1a1a22','#8b5cf6','#eeebf5'] },
  aurora:    { label: 'Aurora',        accent: '#34d399', void: '#060d0b', surface: '#0a1410', card: '#0e1a15', cardUp: '#13211c', text: '#e6f4ec', text2: '#aad0bc', text3: '#88a899', text4: '#607f72', glass: 'rgba(52,211,153,0.05)', glassBorder: 'rgba(52,211,153,0.12)', glow: 'rgba(52,211,153,0.1)', bodyBg: '#060d0b', preview: ['#060d0b','#13211c','#34d399','#e6f4ec'] },
  ember:     { label: 'Ember',          accent: '#f97316', void: '#0d0806', surface: '#14100c', card: '#1a1410', cardUp: '#221b15', text: '#f7ede2', text2: '#ccbba6', text3: '#a99988', text4: '#7e6f5c', glass: 'rgba(249,115,22,0.05)', glassBorder: 'rgba(249,115,22,0.12)', glow: 'rgba(249,115,22,0.1)', bodyBg: '#0d0806', preview: ['#0d0806','#221b15','#f97316','#f7ede2'] },
  arctic:    { label: 'Arctic',        accent: '#38bdf8', void: '#060a0f', surface: '#0a1018', card: '#0e1520', cardUp: '#141c28', text: '#e4eff7', text2: '#a8c1d3', text3: '#869fb1', text4: '#5e7689', glass: 'rgba(56,189,248,0.05)', glassBorder: 'rgba(56,189,248,0.12)', glow: 'rgba(56,189,248,0.1)', bodyBg: '#060a0f', preview: ['#060a0f','#141c28','#38bdf8','#e4eff7'] },
  rose:      { label: 'Ros\u00e9',     accent: '#f472b6', void: '#0d060a', surface: '#140c12', card: '#1a1018', cardUp: '#22161f', text: '#f7e4ed', text2: '#d3acbf', text3: '#b186a0', text4: '#825d72', glass: 'rgba(244,114,182,0.05)', glassBorder: 'rgba(244,114,182,0.12)', glow: 'rgba(244,114,182,0.1)', bodyBg: '#0d060a', preview: ['#0d060a','#22161f','#f472b6','#f7e4ed'] },
  carbon:    { label: 'Carbon',        accent: '#a1a1aa', void: '#09090b', surface: '#111113', card: '#18181b', cardUp: '#1f1f23', text: '#ededf0', text2: '#b4b4bd', text3: '#9292a0', text4: '#6c6c77', glass: 'rgba(255,255,255,0.05)', glassBorder: 'rgba(255,255,255,0.1)', glow: 'rgba(255,255,255,0.09)', bodyBg: '#09090b', preview: ['#09090b','#1f1f23','#a1a1aa','#ededf0'] },
  sakura:    { label: 'Sakura',        accent: '#e879a0', void: '#0c070a', surface: '#120e11', card: '#1a1318', cardUp: '#201920', text: '#f5e4eb', text2: '#d0aaba', text3: '#b08fa0', text4: '#825d6f', glass: 'rgba(232,121,160,0.05)', glassBorder: 'rgba(232,121,160,0.12)', glow: 'rgba(232,121,160,0.1)', bodyBg: '#0c070a', preview: ['#0c070a','#201920','#e879a0','#f5e4eb'] },
  contrast:  { label: 'Contrast',      accent: '#ffff00', void: '#000000', surface: '#0a0a0a', card: '#111111', cardUp: '#1c1c1c', text: '#ffffff', text2: '#ffffff', text3: '#dadada', text4: '#b0b0b0', glass: 'rgba(255,255,255,0.06)', glassBorder: 'rgba(255,255,255,0.45)', glow: 'rgba(255,255,0,0.2)', bodyBg: '#000000', preview: ['#000000','#1c1c1c','#ffff00','#ffffff'] },
};
...
export const I: Record<string, React.ReactNode> = {
  ...
  /** Simple die — random pick */
  dice: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="4" width="16" height="16" rx="3"/><circle cx="9" cy="9" r="1.25" fill="currentColor" stroke="none"/><circle cx="15" cy="15" r="1.25" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.25" fill="currentColor" stroke="none"/></svg>,
  ...
  checkSquare: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>,
};
